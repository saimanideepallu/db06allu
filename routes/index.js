...
router.get('/', function(req, res) {
  res.render('index', { title: 'package App', user:req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'package App Registration'});
  });
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'package App Login', user : req.user });
});
